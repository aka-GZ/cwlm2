...
public class PreferencesUtil {
	private static String PreferenceName = "AkawokConstant";
	 ...
	 * 取出StartNum值
	 */
	public static int getStartNumPreferences(Context context, String name) {
		SharedPreferences sp = context.getSharedPreferences(PreferenceName, Context.MODE_PRIVATE);
	...
	/**
	 * 将StartNum信息存入Preferences
	 *
	 * @param context
	 */
	public static void setStartNumPreferences(Context context, String name, int value) {
		SharedPreferences sp = context.getSharedPreferences(PreferenceName, Context.MODE_PRIVATE);
